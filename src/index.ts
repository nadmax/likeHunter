...
// --- DEBUT : Gestion des messages (maintenant EN DEHORS de 'ready') ---
client.on('messageCreate', async message => {
  ...
  // GESTION DE !vacances (doit être en premier pour fonctionner dans le salon général)
  ...
  // VERIFICATION DU SALON MODERATEUR (pour les commandes admin)
  ...
  // IGNORER LES BOTS (pour les commandes admin)
  if (message.author.bot) {
    console.log('[DEBUG] Message ignoré car provient d\'un bot');
    return;
  }

  // GESTION DES COMMANDES ADMIN (!scan jour/semaine)
